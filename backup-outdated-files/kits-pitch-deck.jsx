...
import haloFlavorsImg    from '../competition/halo-flavors.png';
import rawBitesImg       from '../competition/raw-bites.png';
          ...
          <div key={ci} style={{
            ...
            {comp.img ? (
              ...
              <div style={{
                ...
                padding: "10px 14px", flexShrink: 0, minHeight: 44,
            ...
            <div style={{ padding: "10px 12px", flex: 1, display: "flex", flexDirection: "column" }}>
              ...
              {comp.price && (
                <div style={{ fontFamily: "monospace", fontSize: 8, color: C.amber, marginBottom: 6, lineHeight: 1.3 }}>{comp.price}</div>
              )}
              ...
              {slide.competitors.map((comp, i) => {
                ...
                return (
                  <th key={i} style={{
                    ...
                    fontSize: isUs ? 8.5 : 7.5,
                    color: isUs ? C.greenBright : C.creamDim,
                    textAlign: "center",
                    borderBottom: `2px solid ${isUs ? C.greenBright : C.ash}`,
                ...
                {slide.competitors.map((comp, ci) => {
                  ...
                  return (
                    <td key={ci} style={{
                      ...
                      background: isUs ? `${C.greenBright}07` : "transparent"
                    }}>
                      <div style={{
                        display: "inline-flex", flexDirection: "column", alignItems: "center",
                        gap: 3, background: b.bg, borderRadius: 3, padding: "4px 8px", minWidth: 40
                      }}>
    ...
    groups: [
        ...
        competitors: [
          ...
          },
          {
            ...
            gaps: [
              ...
              "Halal certification unconfirmed — operating in Lebanese Muslim market since 2016 but no explicit halal mark confirmed",
          ...
          },
          {
            ...
            gaps: [
              ...
              "700+ outlets including Carrefour and Spinneys — significant retail footprint, proven local protein market demand",
              "Proved the Lebanese consumer buys locally-made protein snacks in modern trade — STRIKE enters as the only meat-based option",
            ]
          }
        ]
      },
      {
        ...
        competitors: [
          {
            name: "Quest Bar",
            origin: "USA · Dedicated Lebanon distributor (Dbayeh) · Spinneys Lebanon",
            category: "Protein Bar — Global Leader",
            price: "$3.50–5 per bar (distributor-priced in Lebanon) · confirmed at Spinneys Lebanon",
            img: null,
            gaps: [
          ...
          },
          {
            ...
            img: null,
            gaps: [
              "Mixed halal status — most bars certified, but US-produced SKUs (Double Bite Peanut, some Soft Bars) not halal-certified. Consumers must verify SKU by SKU.",
  ...
  },
  {
    ...
    criteria: [
      ...
      },
      {
        ...
        text:  { jl: "$5.15–5.62/40g", ca: "~$6–8/pack", acup: "$2.29–3.57", quest: "$3.50–5", strike: "$2.50–3.50" }
      },
      {
